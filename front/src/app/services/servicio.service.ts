...
export class ServicioService {
  ...
  asignarServicio(servicio: any): Observable<any> {
    return this.http.post(`${this.apiUrl}/asignar`, servicio);
  }
  getServiciosPorCuidador(): Observable<any> {
    return this.http.get(`${this.apiUrl}/servicios/countchart`);
  }
